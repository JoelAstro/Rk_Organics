      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-sage-light text-sm leading-relaxed max-w-sm">
            ...
            <div className="pt-2">
              <a
                ...
                className="btn-premium inline-flex items-center gap-2 px-5 py-3 bg-gold hover:bg-gold-light text-forest-dark font-bold text-xs uppercase tracking-wider rounded-xl transition-all shadow-md cursor-pointer"
              >
          ...
          <div className="lg:col-span-3 space-y-6">
            <h3 className="font-serif text-lg font-semibold text-white border-b border-gold/20 pb-2 inline-block">
              Quick Links
            </h3>
        ...
        <div className="border-t border-sage/10 py-6 text-center lg:text-left">
          <div className="bg-forest-dark/40 border border-sage/10 rounded-2xl p-5 flex flex-col lg:flex-row gap-4 items-start">
        ...
        {/* Bottom Strip */}
        <div className="border-t border-sage/10 pt-8 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4">
          ...
          <div className="flex items-center gap-6 text-[10px] text-sage-light font-bold uppercase tracking-wider font-button">
            <button
              ...
              className="text-gold hover:text-gold-light flex items-center gap-1.5 transition-colors cursor-pointer"
            >
              <HelpCircle size={12} />
              Content Review Panel
            </button>
            <span className="border-l border-sage/20 h-4 hidden sm:block"></span>
